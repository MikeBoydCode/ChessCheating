...
arduino.write(bytes('a1b1', 'utf-8'))
    ...
    def play_game(self, window, engine_id_name, board):
        ...
        while not board.is_game_over(claim_draw=True):
            ...
            # Else if side to move is not human
                ...
                #################################### Mike Boyd Code
                print(move_str)
                move_str_ = move_str + 'x'
                arduino.write(bytes(move_str_, 'utf-8'))
                time.sleep(1)
